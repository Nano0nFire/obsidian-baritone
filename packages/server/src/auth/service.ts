...
export class AuthService {
  constructor(private readonly repo: AuthRepository, private readonly tokens: TokenService) {}
  ...
  async login(username: string, password: string, vaultId: string, deviceName: string): Promise<{ accessToken: string; refreshToken: string; deviceId: string }> {
